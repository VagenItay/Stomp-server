...
public:
    ...
    void update_Summary(bool flag, Event event);
    void insertDataToMap(map<string,string> &map, string input);
    void insertDataToUnOrderedMap(unordered_map<string,string> &map, string input);
